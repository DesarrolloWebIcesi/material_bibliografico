			...
			if (resultado) {
				...
				if (resultado) {
					...
					if (resultado) {
						resultado = resultado && verificarCampo(document.formulario.autor, 'Autor');
						if (resultado) {
							if(document.formulario.volumen!=null && document.formulario.volumen!=''){
								resultado = resultado && isNumber(document.formulario.volumen, 'volumen');
							}
							if(resultado){
								if(document.formulario.numero!=null && document.formulario.numero!=''){
									resultado = resultado && isNumber(document.formulario.numero, 'número');
								}
								if(resultado){
									resultado = resultado && verificarCampo(document.formulario.fechaPublicacion, 'Año de publicación');
									if (resultado) {
